...
The pool of potential reservoirs was derived from two sources.  The first source was the list of Ohio reservoirs contained in the US Army Corps of Engineers National Inventory of Dams (NID).  This list included 85 dams located on 81 separate reservoirs.  The second source is the collection of reservoirs managed by the US Army Corps of Engineers (USACE) within the USACE Louisville District (LD).  The LD includes portions of Ohio, Kentucky, and Indiana.  
