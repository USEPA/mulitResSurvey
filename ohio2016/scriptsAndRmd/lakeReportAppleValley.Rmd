...
Table 1: Water quality parameters measured via sonde at each site
...
Table 2: Water chemistry parameters measured at one shallow and one deep site
```{r warning=FALSE, echo=FALSE} 
...
I have a call into John Olszewski about this.
