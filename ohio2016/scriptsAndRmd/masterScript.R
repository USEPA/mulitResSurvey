...
source("ohio2016/scriptsAndRmd/readLgr.R") # Reads in raw LGR data, 16s
...
source("ohio2016/scriptsAndRmd/plotCleanLgr.R") # Merges chamber time with eqAreaData, 3min
