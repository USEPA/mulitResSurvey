---
title: "Water Quality and Methane Emissions at Tappan Lake"
...
This preliminary report presents results from the USEPA 2016 measurement campaign relevant to Tappan Lake. These data will be included in a formal peer-reviewed publication to be submitted for publication in early 2018.  This preliminary report includes:  
...
ggmap(tappanSat) +
  ...
  geom_text(data=filter(tappanSites84@data, EvalStatus == "sampled"), #only main sites
...
The chlorophyll a levels in Tappan Lake displayed a similar pattern to that of the CH~4~ emissions, with higher levels in the upstream area and lower levels near the dam. 

```{r echo=FALSE, warning=F, message=F, error=F, fig.width=7, fig.height=7, fig.cap='*Chlorophyll a concentrations measured at the 15 sample sites within Tappan Lake. The height of each "lollipop" corresponds to the concentration shown on the vertical z-axis in units of micrograms per liter of water.*' }
##########################################################################
### chlorophyll plot
with(tappanSitesPlot@data, {
