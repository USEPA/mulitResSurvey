...
```{r results='hide', message=FALSE, warning=FALSE, echo=FALSE, fig.cap='*Location of the fifteen sample sites within Lake Roaming Rock. Satellite image from Google Maps.*'}
