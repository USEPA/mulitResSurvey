...
All sampling locations in Charles Mill Lake were emitting CH~4~ to the atmosphere, though there was no obvious within-lake spatial pattern (Fig. 2).

```{r echo=FALSE, warning=F, message=F, error=F, fig.width=7, fig.height=7, fig.cap='*Methane emissions measured at the 15 sample sites within Charles Mill Lake, located in north-central Ohio. The height of each "lollipop" corresponds to the emission rate shown on the vertical z-axis in units of milligrams CH~4~ per square meter of lake surface per hour.*' }
...
Chlorophyll a was abundant throughout the lake (Fig. 3).  Overall, Charles Mill Lake had the second highest chloropyll a abundance of the 32 lakes (Fig. 5). 

```{r echo=FALSE, warning=F, message=F, error=F, fig.width=7, fig.height=7, fig.cap='*Chlorophyll a concentrations measured at the 15 sample sites within Charles Mill Lake, located in north-central Ohio. The height of each "lollipop" corresponds to the concentration shown on the vertical z-axis in units of micrograms per liter of water.*' }
##########################################################################
### chlorophyll plot
with(charlesMillSites84@data, {
