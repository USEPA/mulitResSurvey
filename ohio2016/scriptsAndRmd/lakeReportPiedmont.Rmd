---
title: "Water Quality and Methane Emissions at Piedmont Lake"
...
This preliminary report presents results from the USEPA 2016 measurement campaign relevant to Piedmont Lake. These data will be included in a formal peer-reviewed publication to be submitted for publication in early 2018.  This preliminary report includes:  
...
ggmap(piedmontSat) +
  ...
  geom_text(data=filter(piedmontSites84@data, EvalStatus == "sampled"), #only main sites
...
with(piedmontSitesPlot@data, {
  ch4_plot <- scatterplot3d_edit(x=coords$long, y=coords$lat, z=rep(0,length(coords$long)),   # x y and z data, respectively
                                   ...
                                   angle=50,                                      # angle aspect of plot (-40)
...
The chlorophyll a levels in Piedmont Lake displayed a similar pattern to that of the CH~4~ emissions, with higher levels in the upstream area and lower levels near the dam. 

```{r echo=FALSE, warning=F, message=F, error=F, fig.width=7, fig.height=7, fig.cap='*Chlorophyll a concentrations measured at the 15 sample sites within Piedmont Lake. The height of each "lollipop" corresponds to the concentration shown on the vertical z-axis in units of micrograms per liter of water.*' }
##########################################################################
### chlorophyll plot
with(piedmontSitesPlot@data, {
...
```{r echo=FALSE, warning=FALSE, fig.width=7, fig.height=7, fig.cap='*Mean and 95% confidence interval (CI) of the total phosphorus (TP) concentration for each reservoir in this study, calculated from the values measured at one shallow and one deep site within each reservoir.*'  }
...
```{r echo=FALSE, warning=FALSE, fig.width=7, fig.height=7, fig.cap='*Mean and 95% confidence interval (CI) of the total nitrogen (TN) concentration for each reservoir in this study, calculated from the values measured at one shallow and one deep site within each reservoir.*'  }
