...
Table 1: Surface (0.1 m) water quality parameters measured via sonde at each site on June 27^th^, 2016. "Site Depth" is the measure of how deep the lake was at each site. 
...
Table 2: Surface (0.1 m) water chemistry parameters measured at one shallow and one deep site on June 27^th^, 2016. "Site Depth" is the measure of how deep the lake was at each site. 
```{r warning=FALSE, echo=FALSE} 
