######################################################################################
#   THE DESIGN BELOW, USING A RANDOM SEED OF 4447864, WAS NOT PUSHED TO THE          #
#   GEOPLATFORM.  THE GEOPLATFORM MAP, WHICH WAS USED IN THE FIELD, MUST HAVE        #
#   BEEN GENERATED USING A DIFFERENT RANDOM SEED.  SHAPEFILES IN DIRECTORY           #
#   WERE PULLED FROM GEOPLATFROM ON 10/11/2016.                                      #
######################################################################################
...
#                              out.shape=paste(rootDir, "cowan/cowanSitesEqArea2", sep=""))
# 
# 
