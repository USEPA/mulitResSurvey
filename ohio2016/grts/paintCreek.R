...
# TRIBUTARY AREAS MAKE UP A SIZABLE PORTION OF THE RESERVOIR, SO LETS TRY AN
...
paintCreekDsgn <- list(None=list(panel=c(mainSites=15), # unstratified, therefore 1 list
                            seltype="Equal",
...
points(paintCreekSites$xcoord, paintCreekSites$ycoord)
...
ggmap(paintCreekSat) +
  ylab("Latitude") +
  xlab ("Longitude") +
  geom_polygon(data=paintCreekEqArea84.f, aes(long, lat, group=group, fill="Open Water")) +
